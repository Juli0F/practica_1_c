  ...
  public final Symbol CUP$parser$do_action_part00000000(
    ...
    throws Exception
    {
      ...
      switch (CUP$parser$act_num)
		...
		String val = (String)((Symbol) CUP$parser$stack.peek()).value;
              ...
              CUP$parser$result = parser.getSymbolFactory().newSymbol("inicio",12, ((Symbol)CUP$parser$stack.peek()), ((Symbol)CUP$parser$stack.peek()), RESULT);
            }
		...
		RESULT = start_val;
          ...
          case 2: // sentencia ::= graph sen_1 
            {
              String RESULT =null;
		int grleft = ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)).left;
		int grright = ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)).right;
		String gr = (String)((Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		int sn1left = ((Symbol)CUP$parser$stack.peek()).left;
		int sn1right = ((Symbol)CUP$parser$stack.peek()).right;
		String sn1 = (String)((Symbol) CUP$parser$stack.peek()).value;
		 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("sentencia",5, ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
          ...
          case 3: // sentencia ::= animacion sen_1 
            {
              String RESULT =null;
		int anleft = ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)).left;
		int anright = ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)).right;
		String an = (String)((Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		int sn1left = ((Symbol)CUP$parser$stack.peek()).left;
		int sn1right = ((Symbol)CUP$parser$stack.peek()).right;
		String sn1 = (String)((Symbol) CUP$parser$stack.peek()).value;
		...
		String sn = (String)((Symbol) CUP$parser$stack.peek()).value;
		RESULT = an + " "+ sn ;
              CUP$parser$result = parser.getSymbolFactory().newSymbol("sen_1",15, ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
          ...
          case 7: // sen_1 ::= 
            {
              String RESULT =null;
		RESULT = " ";
              CUP$parser$result = parser.getSymbolFactory().newSymbol("sen_1",15, ((Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
          ...
          case 8: // graph ::= GRAFICAR figura 
            {
              String RESULT =null;
		int fileft = ((Symbol)CUP$parser$stack.peek()).left;
		int firight = ((Symbol)CUP$parser$stack.peek()).right;
		String fi = (String)((Symbol) CUP$parser$stack.peek()).value;
		
 	lstSentencias.add(fi); RESULT = "graficar "+fi;

              CUP$parser$result = parser.getSymbolFactory().newSymbol("graph",16, ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
          ...
          case 9: // animacion ::= ANIMAR OBJETO ANTERIOR PAR_ABIERTO s COMA s COMA tipo_animacion PAR_CERRADO 
            {
              String RESULT =null;
		int s1left = ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-5)).left;
		int s1right = ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-5)).right;
		Integer s1 = (Integer)((Symbol) CUP$parser$stack.elementAt(CUP$parser$top-5)).value;
		int s2left = ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-3)).left;
		int s2right = ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-3)).right;
		Integer s2 = (Integer)((Symbol) CUP$parser$stack.elementAt(CUP$parser$top-3)).value;
		int t_anleft = ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)).left;
		int t_anright = ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)).right;
		String t_an = (String)((Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		
	lstSentencias.add("animacion, "+s1+","+s2+","+t_an);
	RESULT = "animar objeto anterior ( "+s1+","+s2+","+t_an+")"; 

              CUP$parser$result = parser.getSymbolFactory().newSymbol("animacion",13, ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-9)), ((Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
		...
		String li = (String)((Symbol) CUP$parser$stack.peek()).value;
		 RESULT = li; contAnimacionLinea++;
              CUP$parser$result = parser.getSymbolFactory().newSymbol("tipo_animacion",17, ((Symbol)CUP$parser$stack.peek()), ((Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
          ...
          case 11: // tipo_animacion ::= CURVA 
            {
              String RESULT =null;
		int culeft = ((Symbol)CUP$parser$stack.peek()).left;
		int curight = ((Symbol)CUP$parser$stack.peek()).right;
		String cu = (String)((Symbol) CUP$parser$stack.peek()).value;
		RESULT = cu; contAnimacionCurva++;
          ...
          case 12: // figura ::= CUADRADO cuadrado 
            {
              String RESULT =null;
		int cualeft = ((Symbol)CUP$parser$stack.peek()).left;
		int cuaright = ((Symbol)CUP$parser$stack.peek()).right;
		String cua = (String)((Symbol) CUP$parser$stack.peek()).value;
		RESULT = "cuadrado"+cua; contCuadrado++;
              CUP$parser$result = parser.getSymbolFactory().newSymbol("figura",6, ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
          ...
          case 13: // figura ::= CIRCULO circulo 
            {
              String RESULT =null;
		int cirleft = ((Symbol)CUP$parser$stack.peek()).left;
		int cirright = ((Symbol)CUP$parser$stack.peek()).right;
		String cir = (String)((Symbol) CUP$parser$stack.peek()).value;
		RESULT = "circulo"+cir; contCirculo++;
          ...
          case 14: // figura ::= RECTANGULO rectangulo 
            {
              String RESULT =null;
		int recleft = ((Symbol)CUP$parser$stack.peek()).left;
		int recright = ((Symbol)CUP$parser$stack.peek()).right;
		String rec = (String)((Symbol) CUP$parser$stack.peek()).value;
		RESULT = "rectangulo"+rec; contRectangulo++;
          ...
          case 15: // figura ::= LINEA linea 
            {
              String RESULT =null;
		int linleft = ((Symbol)CUP$parser$stack.peek()).left;
		int linright = ((Symbol)CUP$parser$stack.peek()).right;
		String lin = (String)((Symbol) CUP$parser$stack.peek()).value;
		RESULT = "linea"+lin; contLinea++;
          ...
          case 16: // figura ::= POLIGONO poligono 
            {
              String RESULT =null;
		int polleft = ((Symbol)CUP$parser$stack.peek()).left;
		int polright = ((Symbol)CUP$parser$stack.peek()).right;
		String pol = (String)((Symbol) CUP$parser$stack.peek()).value;
		RESULT = "poligono"+pol; contPoligono++;
          ...
          case 17: // circulo ::= PAR_ABIERTO s COMA s COMA s COMA color PAR_CERRADO 
            {
              String RESULT =null;
		int s1left = ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-7)).left;
		int s1right = ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-7)).right;
		Integer s1 = (Integer)((Symbol) CUP$parser$stack.elementAt(CUP$parser$top-7)).value;
		int s2left = ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-5)).left;
		int s2right = ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-5)).right;
		Integer s2 = (Integer)((Symbol) CUP$parser$stack.elementAt(CUP$parser$top-5)).value;
		int s3left = ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-3)).left;
		int s3right = ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-3)).right;
		Integer s3 = (Integer)((Symbol) CUP$parser$stack.elementAt(CUP$parser$top-3)).value;
		int colleft = ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)).left;
		int colright = ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)).right;
		String col = (String)((Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		RESULT = ","+s1+","+s2+","+s3+","+col;
              CUP$parser$result = parser.getSymbolFactory().newSymbol("circulo",8, ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-8)), ((Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
		...
		String col = (String)((Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		RESULT = ","+s1+","+s2+","+s3+","+col;
              CUP$parser$result = parser.getSymbolFactory().newSymbol("cuadrado",7, ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-8)), ((Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
          ...
          case 19: // rectangulo ::= PAR_ABIERTO s COMA s COMA s COMA s COMA color PAR_CERRADO 
            {
              String RESULT =null;
		int s1left = ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-9)).left;
		int s1right = ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-9)).right;
		Integer s1 = (Integer)((Symbol) CUP$parser$stack.elementAt(CUP$parser$top-9)).value;
		int s2left = ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-7)).left;
		int s2right = ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-7)).right;
		Integer s2 = (Integer)((Symbol) CUP$parser$stack.elementAt(CUP$parser$top-7)).value;
		int s3left = ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-5)).left;
		int s3right = ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-5)).right;
		Integer s3 = (Integer)((Symbol) CUP$parser$stack.elementAt(CUP$parser$top-5)).value;
		int s4left = ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-3)).left;
		int s4right = ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-3)).right;
		Integer s4 = (Integer)((Symbol) CUP$parser$stack.elementAt(CUP$parser$top-3)).value;
		int colleft = ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)).left;
		int colright = ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)).right;
		String col = (String)((Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		RESULT = ","+s1+","+s2+","+s3+","+s4+","+col;
              CUP$parser$result = parser.getSymbolFactory().newSymbol("rectangulo",9, ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-10)), ((Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
		...
		String col = (String)((Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		RESULT = ","+s1+","+s2+","+s3+","+s4+","+col;
              CUP$parser$result = parser.getSymbolFactory().newSymbol("linea",10, ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-10)), ((Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
          ...
          case 21: // poligono ::= PAR_ABIERTO s COMA s COMA s COMA s COMA s COMA color PAR_CERRADO 
            {
              String RESULT =null;
		int s1left = ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-11)).left;
		int s1right = ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-11)).right;
		Integer s1 = (Integer)((Symbol) CUP$parser$stack.elementAt(CUP$parser$top-11)).value;
		int s2left = ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-9)).left;
		int s2right = ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-9)).right;
		Integer s2 = (Integer)((Symbol) CUP$parser$stack.elementAt(CUP$parser$top-9)).value;
		int s3left = ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-7)).left;
		int s3right = ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-7)).right;
		Integer s3 = (Integer)((Symbol) CUP$parser$stack.elementAt(CUP$parser$top-7)).value;
		int s4left = ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-5)).left;
		int s4right = ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-5)).right;
		Integer s4 = (Integer)((Symbol) CUP$parser$stack.elementAt(CUP$parser$top-5)).value;
		int s5left = ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-3)).left;
		int s5right = ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-3)).right;
		Integer s5 = (Integer)((Symbol) CUP$parser$stack.elementAt(CUP$parser$top-3)).value;
		int colleft = ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)).left;
		int colright = ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)).right;
		String col = (String)((Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		RESULT = ","+s1+","+s2+","+s3+","+s4+","+s5+","+col;
              CUP$parser$result = parser.getSymbolFactory().newSymbol("poligono",11, ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-12)), ((Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
          ...
          case 22: // color ::= AZUL 
            {
              String RESULT =null;
		int azleft = ((Symbol)CUP$parser$stack.peek()).left;
		int azright = ((Symbol)CUP$parser$stack.peek()).right;
		String az = (String)((Symbol) CUP$parser$stack.peek()).value;
		 RESULT = az; contAzul++;
              CUP$parser$result = parser.getSymbolFactory().newSymbol("color",14, ((Symbol)CUP$parser$stack.peek()), ((Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
		...
		String ro = (String)((Symbol) CUP$parser$stack.peek()).value;
		RESULT = ro; contRojo++;
              CUP$parser$result = parser.getSymbolFactory().newSymbol("color",14, ((Symbol)CUP$parser$stack.peek()), ((Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
          ...
          case 24: // color ::= VERDE 
            {
              String RESULT =null;
		int veleft = ((Symbol)CUP$parser$stack.peek()).left;
		int veright = ((Symbol)CUP$parser$stack.peek()).right;
		String ve = (String)((Symbol) CUP$parser$stack.peek()).value;
		 RESULT = ve; contVerde++; 
              CUP$parser$result = parser.getSymbolFactory().newSymbol("color",14, ((Symbol)CUP$parser$stack.peek()), ((Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
          ...
          case 25: // color ::= AMARILLO 
            {
              String RESULT =null;
		int amleft = ((Symbol)CUP$parser$stack.peek()).left;
		int amright = ((Symbol)CUP$parser$stack.peek()).right;
		String am = (String)((Symbol) CUP$parser$stack.peek()).value;
		RESULT = am; contAmarillo++;
          ...
          case 26: // color ::= NARANJA 
            {
              String RESULT =null;
		int naleft = ((Symbol)CUP$parser$stack.peek()).left;
		int naright = ((Symbol)CUP$parser$stack.peek()).right;
		String na = (String)((Symbol) CUP$parser$stack.peek()).value;
		RESULT = na; contNaranja++;
          ...
          case 27: // color ::= MORADO 
            {
              String RESULT =null;
		int moleft = ((Symbol)CUP$parser$stack.peek()).left;
		int moright = ((Symbol)CUP$parser$stack.peek()).right;
		String mo = (String)((Symbol) CUP$parser$stack.peek()).value;
		RESULT = mo; contMorado++;
          ...
          case 28: // color ::= CAFE 
            {
              String RESULT =null;
		int caleft = ((Symbol)CUP$parser$stack.peek()).left;
		int caright = ((Symbol)CUP$parser$stack.peek()).right;
		String ca = (String)((Symbol) CUP$parser$stack.peek()).value;
		RESULT = ca; contCafe++;
              CUP$parser$result = parser.getSymbolFactory().newSymbol("color",14, ((Symbol)CUP$parser$stack.peek()), ((Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
          ...
          case 29: // color ::= NEGRO 
            {
              String RESULT =null;
		int neleft = ((Symbol)CUP$parser$stack.peek()).left;
		int neright = ((Symbol)CUP$parser$stack.peek()).right;
		String ne = (String)((Symbol) CUP$parser$stack.peek()).value;
		RESULT = ne; contNegro++;
              CUP$parser$result = parser.getSymbolFactory().newSymbol("color",14, ((Symbol)CUP$parser$stack.peek()), ((Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
		...
		Integer e1 = (Integer)((Symbol) CUP$parser$stack.peek()).value;
		...
		Integer e1 = (Integer)((Symbol) CUP$parser$stack.peek()).value;
		  RESULT = e+e1;
			...
			signo = " + "; 
              ...
              CUP$parser$result = parser.getSymbolFactory().newSymbol("z",3, ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
		...
		signo="";
              ...
              CUP$parser$result = parser.getSymbolFactory().newSymbol("z",3, ((Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
	...
	switch (signo) {
			...
			RESULT = e;
              ...
              CUP$parser$result = parser.getSymbolFactory().newSymbol("t",1, ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
		...
		Integer e1 = (Integer)((Symbol) CUP$parser$stack.peek()).value;
			...
			signo=" * ";
              ...
              CUP$parser$result = parser.getSymbolFactory().newSymbol("r",4, ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
		...
		signo="&";
              ...
              CUP$parser$result = parser.getSymbolFactory().newSymbol("r",4, ((Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
		...
		Integer e = (Integer)((Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
              ...
              CUP$parser$result = parser.getSymbolFactory().newSymbol("f",2, ((Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
		...
		RESULT = e;
              CUP$parser$result = parser.getSymbolFactory().newSymbol("f",2, ((Symbol)CUP$parser$stack.peek()), ((Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
